...
The \LaTeX\ source for this booklet can be freely accessed on GitHub.
{\small
\texttt{\href{https://github.com/NCCTS/nccts.org/blob/latest/site/source/tex/}
             {https://github.com/NCCTS/nccts.org/blob/latest/site/source/tex/}}
}
